...
#
# Example:
#   bash experiments/launch_detached_screen.sh ellphi_tuned30 \
#     outputs/supervised/20260703_ellphi_tuned_full120_30ep_screen/driver.log \
#     experiments/run_ellphi_tuned_full120_30ep.sh
